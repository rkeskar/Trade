...
This CRUD application is build using Laravel 6.x, PHP > 7, Vue.js, jQuery, Axios, Bootstrap. It is a single page application. I built and ran this application on Laravel Homestead and I did it because homestead provides a complete development environment.
